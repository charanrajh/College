    ...
    <div class="wrapper">
       ...
       <%@ include file="dashboard/dashboardheader.jsp" %>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            List<PlacementInfo> studentPlacementInfo = new ArrayList<PlacementInfo>();
            studentPlacementInfo = studentDao.getPlacementInfo();
 			
			 %>
			  
           
       <strong><h3 class="text-center">Placement Calendar</a></h3></strong>
<br></br>
  ...
  <table class="table table-bordered">
	      ...
	      <%
 Iterator<PlacementInfo> iterator = studentPlacementInfo.iterator();  // Iterator interface
 
 while(iterator.hasNext())  // iterate through all the data until the last record
 {
	 PlacementInfo placementInfo = iterator.next(); //assign individual employee record to the employee class object
 %>
	 <tr><td><%=placementInfo.getCompany()%></td>
	  <td><%=placementInfo.getEventDate()%></td>
