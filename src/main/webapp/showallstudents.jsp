       ...
       <%@ include file="adminheader.jsp" %>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            allStudents = studentDao.getAllStudents();
			 ...
			 %>
			       <strong><h3 class="text-center">Students</a></h3></strong>
<br></br>
...
<%
 Iterator<Student> iterator = allStudents.iterator();  // Iterator interface
 
 while(iterator.hasNext())  // iterate through all the data until the last record
 {
	 Student student = iterator.next(); //assign individual employee record to the employee class object
 %>
	 <tr><td><%=student.getStdId()%></td>
	 <td><%=student.getStdName()%></td>
	 <td><%=student.getStdDeptName()%></td>
	 <td><%=student.getStdSem()%></td>
	 <td><%=student.getStdCourseName()%></td>
	  <td><%=student.getStdEmail()%></td>
	  <td><%=student.getStdPhone()%></td>
